...
- The Duke Lemur Center provides more information [on their official webpage](https://lemur.duke.edu/accordions/ring-tailed-lemurs-species-page/)

] <!--end of pull left-->

.pull-right[

```{r, fig.alt="Ring-tailed lemurs with alternating black and white rings along the entire length of their tail", echo=FALSE}
